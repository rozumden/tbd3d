...
% Subproblem in estimateFM_3map_* - projection of (m,f) values to feasible "pyramid"-like intersection of convex sets (roughly all positive, m<=1, m>=f)
% Faster version using Dykstra's algorithm, see eg Ryan J. Tibshirani, Dykstra’s Algorithm, ADMM, and Coordinate Descent: Connections, Insights, and Extensions, NIPS 2017
